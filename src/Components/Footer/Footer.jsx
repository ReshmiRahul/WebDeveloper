...
const Footer = () => {
    ...
    return (
        <>
            <div id='Contact' className='flex flex-col-reverse md:flex-row justify-around bg-[#00000] text-white p-10 md:p-12 items-center'>
                <div>
                ...
                <div className='flex flex-col justify-center items-center mt-4 md:mt-0'>
                    ...
                    <ul className='mt-6 flex flex-col justify-center'>
                        ...
                        <li className='flex items-center gap-1 font-semibold text-gray-300'><MdOutlineEmail className='mt-1' />reshmihl94@gmail.com</li>
                    </ul>
                    <ul className='text-sm md:text-xl flex justify-center items-center md:flex-row md:gap-5 mt-4'>

                        <a href="https://www.linkedin.com/in/reshmi-h-l-811845249" target='_blank'
                        ...
                        <a href="https://github.com/ReshmiRahul" target='_blank'
            ...
            <div className=' text-white text-center my-2 hover:text-gray-300 text-xs'>
                <p>&copy; 2024 RHL Portfolio &hearts; | All right reserved.</p>
            </div>
        </>
    )
}
